...
var portBasename = fmt.Sprintf("hextime-%s", hextime.Version)

// repoNamespace identifies the Go namespace for this project.
var repoNamespace = "github.com/mcandre/go-hextime"
...
func Uninstall() error { return mageextras.Uninstall("hextime") }
